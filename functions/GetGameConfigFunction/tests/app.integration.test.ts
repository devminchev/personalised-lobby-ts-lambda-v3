...
describe('Integration Test for Lambda Handler', () => {
    ...
    describe('Successful response for 2xx status codes', () => {
        it('Should return (200) response when AWS OS returns one entry with no locale provided', async () => {
        ...
        it('Should return (200) response when AWS OS returns one entry with ES locale provided', async () => {
            nock('http://localhost:9200')
                .post(`/${VENTURES_INDEX_ALIAS}/_search?request_cache=true`)
                .reply(200, VENTURE_SUCCESS_RESP);
            nock('http://localhost:9200')
        ...
        it('Should return (200) response when AWS OS returns one entry with no locale provided and siteGame config overrides Game config', async () => {
            nock('http://localhost:9200')
                .post(`/${VENTURES_INDEX_ALIAS}/_search?request_cache=true`)
                .reply(200, VENTURE_SUCCESS_RESP);
            nock('http://localhost:9200')
        ...
        it('Should return (200) default locale response when AWS OS returns one entry with invalid locale provided', async () => {
            const locale = 'KEVIN WAS HEREE!!!!!';
