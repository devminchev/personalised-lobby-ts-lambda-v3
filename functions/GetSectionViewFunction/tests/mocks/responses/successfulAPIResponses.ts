export const SUCCESSFUL_SECTION_VIEW_RESPONSE = {
    ...
    games: [
        {
            ...
            title: 'Lucky Larry Lobstermania 2',
        ...
        },
        {
            ...
            imgUrlPattern: '/api/content/gametiles/massive-gold-maxxed/scale-s%s/massive-gold-maxxed-tile-r%s-w%s.jpg',
            loggedOutImgUrlPattern:
...
export const SUCCESSFUL_JACKPOT_SECTION_RESPONSE = {
    ...
    title: 'Rapid Fire',
    layoutType: 'grid-a-expanded-jackpot',
    type: 'generic',
    games: [
        {
            name: 'play-bp-dond-megaways-rapid-fire',
            gameSkin: 'BP_DEAL_OR_NO_DEAL_MEGAWAYS_RAPID_FIRE',
            entryId: '1pMF7ymfJ68tV8sgwzxDhU',
            title: 'Deal Or No Deal Megaways Rapid Fire',
            ...
            representativeColor: '#131024',
        },
        {
            name: 'play-bp-fishin-frenzy-even-bigger-fish-rapid-fire',
            gameSkin: 'BP_FISHIN_FRENZY_EVEN_BIGGER_FISH_RAPID_FIRE',
            entryId: '4JJAHVvRozAV5PNY5WAB61',
            title: 'Fishin Frenzy Even Bigger Fish Rapid Fire',
            gameId: '22BTTFeBTl1lKdHzmpvnwL',
            isProgressiveJackpot: false,
            realUrl: '/service/game/play/play-bp-fishin-frenzy-even-bigger-fish-rapid-fire',
            demoUrl: '/service/game/demo/play-bp-fishin-frenzy-even-bigger-fish-rapid-fire',
            imgUrlPattern:
            ...
            representativeColor: '#041F3C',
        },
        {
            name: 'play-bp-big-catch-even-bigger-bass-rapid-fire',
            gameSkin: 'BP_BIG_CATCH_EVEN_BIGGER_FISH_RAPID_FIRE',
            entryId: '3kg384W5gyopOEQxDsAHLz',
            title: 'Big Catch Even Bigger Bass Rapid Fire',
            gameId: 'EBZqHbN1mpA25wfMdrpJw',
            isProgressiveJackpot: false,
            realUrl: '/service/game/play/play-bp-big-catch-even-bigger-bass-rapid-fire',
            demoUrl: '/service/game/demo/play-bp-big-catch-even-bigger-bass-rapid-fire',
            imgUrlPattern:
            ...
            representativeColor: '#4B275D',
        },
    ],
};

export const SUCCESSFUL_SUGGESTED_FOR_YOU_VIEW_RESPONSE: any = {
    ...
    games: [
        {
            ...
            progressiveBackgroundColor: '#298556',
        ...
        },
        {
            ...
            progressiveBackgroundColor: '#2ea977',
            representativeColor: '#206060',
        },
    ],
};
export const SUCCESSFUL_BECAUSE_YOU_PLAYED_RESPONSE: any = {
    classification: 'PersonalisedSection',
